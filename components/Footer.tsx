...
const Footer = () => {
  return (
    <footer className='flex flex-col text-black-100 mt-5 border-t brder-gray-100'>
        <div>
        <div className='flex max-md:flex-colflex-wrap justify-between gap-5 sm:px-16 px-6 py-10'>
